...
export const metadata = {
    title: 'Contact US Dryer Vents | Get a Free Quote Today',
    description: 'Contact our team for questions about dryer vent cleaning, repair, or to schedule a free estimate in your city.',
}
                ...
                <div className="max-w-4xl mx-auto">
                    ...
                    <div className="grid md:grid-cols-2 gap-12">
                        <div className="bg-white p-8 rounded-2xl shadow-xl border border-slate-100">
                            ...
                            <CallBtn className="w-full py-4 text-lg" label="Call Now: +1 (877) 660-4756" />
                        ...
                        <div className="space-y-8">
                            <div>
                                ...
                                <a href="mailto:contact@usdryervents.com" className="text-orange-600 font-semibold hover:underline">contact@usdryervents.com</a>
                            </div>

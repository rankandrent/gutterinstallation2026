        ...
        <section className="py-20 px-6 bg-white border-t border-slate-100">
            <div className="max-w-7xl mx-auto">
                <div className="text-center mb-12">
                    <span className="text-orange-600 font-bold uppercase tracking-wider text-sm">Complete Vent Care</span>
                    <h2 className="text-3xl font-bold text-slate-900 mt-2">Professional Dryer Vent Services</h2>
                </div>
